...
// The card grid follows the reusable homepage pattern shown in Brian Design's React Website Tutorial,
// then adapts it with project-specific text and routes.
